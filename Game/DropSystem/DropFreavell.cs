...
namespace Game.DropSystem
{
    internal class DropFreavell
    {
        ...
        public void DropFreavellBossOne()
        {
            ...
            {
                //Запись дропа голды
                int BronzeDropOne = loadSavePlayer.GetPlayerBronze() + enemyFreavell.bronzeEnemyFreavellBossOne;
                string directoryPathTwo = Path.Combine(AppDomain.CurrentDomain.BaseDirectory/*, "bin", "Debug", "net8.0-windows"*/);
                string filePathTwo = Path.Combine(directoryPathTwo, "gameplayerdata.txt");
                string[] linesTwo = File.ReadAllLines(filePath);
                lines[10] = BronzeDropOne.ToString();
            ...
            {
                //Запись дропа голды + 1
                int BronzeDropTwo = loadSavePlayer.GetPlayerBronze() + enemyFreavell.bronzeEnemyFreavellBossOne + 1;
                string directoryPathTwo = Path.Combine(AppDomain.CurrentDomain.BaseDirectory/*, "bin", "Debug", "net8.0-windows"*/);
                string filePathThree = Path.Combine(directoryPathTwo, "gameplayerdata.txt");
                string[] linesThree = File.ReadAllLines(filePath);
                lines[10] = BronzeDropTwo.ToString();
            ...
            if (randomDiamondDrop < 4)
            {
                ...
                int DiamondDropOne = loadSavePlayer.GetPlayerDiamond() + enemyFreavell.bronzeEnemyFreavellBossOne;
                string directoryPathTwo = Path.Combine(AppDomain.CurrentDomain.BaseDirectory/*, "bin", "Debug", "net8.0-windows"*/);
                string filePathTwo = Path.Combine(directoryPathTwo, "gameplayerdata.txt");
                string[] linesTwo = File.ReadAllLines(filePath);
                lines[13] = DiamondDropOne.ToString();
                File.WriteAllLines(filePathTwo, linesTwo);
                Console.WriteLine("Получено: " + DiamondDropOne + " Алмазов");
            }
            else
            {
                //Нет дропа diamond
        ...
        public void DropFreavellBossTwo()
        {
            ...
            {
                //Запись дропа голды
                int BronzeDropTwo = loadSavePlayer.GetPlayerBronze() + enemyFreavell.bronzeEnemyFreavellBossTwo;
                string directoryPathTwo = Path.Combine(AppDomain.CurrentDomain.BaseDirectory/*, "bin", "Debug", "net8.0-windows"*/);
                string filePathTwo = Path.Combine(directoryPathTwo, "gameplayerdata.txt");
                string[] linesTwo = File.ReadAllLines(filePath);
                lines[10] = BronzeDropTwo.ToString();
            ...
            {
                //Запись дропа голды + 1
                int BronzeDropTwo = loadSavePlayer.GetPlayerBronze() + enemyFreavell.bronzeEnemyFreavellBossTwo + 1;
                string directoryPathTwo = Path.Combine(AppDomain.CurrentDomain.BaseDirectory/*, "bin", "Debug", "net8.0-windows"*/);
                string filePathThree = Path.Combine(directoryPathTwo, "gameplayerdata.txt");
                string[] linesThree = File.ReadAllLines(filePath);
                lines[10] = BronzeDropTwo.ToString();
            ...
            {
                //Запись дропа diamond
                int DiamondDropTwo = loadSavePlayer.GetPlayerDiamond() + enemyFreavell.bronzeEnemyFreavellBossTwo;
                string directoryPathTwo = Path.Combine(AppDomain.CurrentDomain.BaseDirectory/*, "bin", "Debug", "net8.0-windows"*/);
                string filePathTwo = Path.Combine(directoryPathTwo, "gameplayerdata.txt");
                string[] linesTwo = File.ReadAllLines(filePath);
                lines[13] = DiamondDropTwo.ToString();
                File.WriteAllLines(filePathTwo, linesTwo);
                Console.WriteLine("Получено: " + DiamondDropTwo + " Алмазов");
            }
            else
            {
                //Нет дропа diamond
        ...
        public void DropFreavellBossThree()
        {
            ...
            {
                //Запись дропа голды
                int BronzeDropThree = loadSavePlayer.GetPlayerBronze() + enemyFreavell.bronzeEnemyFreavellBossThree;
                ...
                string[] linesThree = File.ReadAllLines(filePath);
                lines[10] = BronzeDropThree.ToString();
                File.WriteAllLines(filePathThree, linesThree);
            ...
            {
                //Запись дропа голды + 1
                int BronzeDropThree = loadSavePlayer.GetPlayerBronze() + enemyFreavell.bronzeEnemyFreavellBossThree + 1;
                string directoryPathThree = Path.Combine(AppDomain.CurrentDomain.BaseDirectory/*, "bin", "Debug", "net8.0-windows"*/);
                string filePathThree = Path.Combine(directoryPathThree, "gameplayerdata.txt");
                string[] linesThree = File.ReadAllLines(filePath);
                lines[10] = BronzeDropThree.ToString();
            ...
            {
                //Запись дропа diamond
                int DiamondDropThree = loadSavePlayer.GetPlayerDiamond() + enemyFreavell.bronzeEnemyFreavellBossTwo;
                string directoryPathThree = Path.Combine(AppDomain.CurrentDomain.BaseDirectory/*, "bin", "Debug", "net8.0-windows"*/);
                string filePathThree = Path.Combine(directoryPathThree, "gameplayerdata.txt");
                string[] linesThree = File.ReadAllLines(filePath);
                lines[13] = DiamondDropThree.ToString();
                File.WriteAllLines(filePathThree, linesThree);
                Console.WriteLine("Получено: " + DiamondDropThree + " Алмазов");
            }
            else
            {
                //Нет дропа diamond
